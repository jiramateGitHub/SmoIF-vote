<?php 
		if($errorlog != '123123admin'){
			echo "<script>location.href = '".site_url("/Vote/")."'</script>";
		}
?>
<script>
	function admin_ch(id){

		$.ajax({
				type: "POST",
				url: "<?php echo site_url('/Admin/admin_ch/');?>"+id,
				data: {
						id: id
				},
...
<?php include "templates/header.php"?>
  ...
  <nav class="navbar navbar-expand-lg bg-secondary fixed-top text-uppercase" id="mainNav">
	...
	<section class="portfolio" id="portfolio" >
        ...
        <span class="letters">เปิดการโหวต</span>
			...
			<div align="middle">
				<div class="row" > 
						...
						<div class="col-md-4 col-sm-4" align="middle">
							<a href="#" class="btn-level1" onclick="admin_ch(1)">
					...
					<br>
						...
						<div class="col-md-4 col-sm-4 " align="middle">
							<a href="#" class="btn-level3" onclick="admin_ch(2)">
						...
						<div class="col-md-4 col-sm-4 " align="middle">
							<a href="<?php echo site_url('/Admin/score/1');?>" class="btn-level2">
								<i class="fas fa-crown"></i>
							</a>
							<h3>ผลโหวต 7ทีม</h3>
						</div>
						...
						<div class="col-md-4 col-sm-4 " align="middle">
							<a href="<?php echo site_url('/Admin/score/2');?>" class="btn-level2">
								<i class="fas fa-crown"></i>
							</a>
							<h3>ผลโหวต 3ทีม</h3>
						</div>
